...
export const COLLECTIONS = {
  ...
  /** Digital return reports (holder → admin → L2 exception). Create via setup script. */
  ASSET_RETURN_REPORTS: process.env.NEXT_PUBLIC_ASSET_RETURN_REPORTS_COLLECTION_ID || "698f0ret01a2b3c4d5e6",
...
export const ENUMS = {
  ...
  /** Condition reported by the holder when submitting a digital return. */
  RETURN_REPORT_CONDITION: {
    GOOD: "GOOD",
    FAIR: "FAIR",
    POOR: "POOR",
    LOST: "LOST",
  ...
  /** L2 catalog availability gate when an admin adds an asset/consumable. */
  AVAILABILITY_CONFIRM_STATUS: {
    NONE: "NONE",
    PENDING: "PENDING",
    CONFIRMED: "CONFIRMED",
    REJECTED: "REJECTED",
